...
from deblurring.models.nafnet.basicsr.metrics.metric_util import reorder_image, to_y_channel
import torch
...
def calculate_skimage_ssim(img1, img2):
    from skimage.metrics import structural_similarity  # lazy: optional dep
